                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-3">
                                        <div className="w-12 h-12 bg-gradient-to-br from-teal-400 to-teal-400 rounded-full flex items-center justify-center text-white font-bold text-lg">
                                    ...
                                    {user.role === 'client' && user.client_cleanings_count !== undefined && (
                                        <div className="flex items-center gap-4 text-sm">
                                            <div className="px-3 py-1 bg-teal-50 text-teal-700 rounded-lg">
