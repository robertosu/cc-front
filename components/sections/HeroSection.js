...
export default function HeroSection() {
    return (
        <section className="bg-gradient-to-br from-teal-400 to-teal-800 text-white py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              {/*  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button className="bg-white text-teal-400 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                        Ver Servicios
                    </button>
                    <button className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-teal-400 transition-colors">
