            ...
            >
                <nav className="flex flex-col p-6 space-y-4">
                    <Link
                        href="/"
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="text-gray-700 hover:text-ocean-400 transition-colors py-2 text-lg"
                    >
                        Inicio
                    </Link>
                    <Link
                    ...
                    <div className="border-t border-gray-200 pt-4 mt-4">
                        {user ? (
                            <Link
                                href="/dashboard"
                                onClick={() => setIsMobileMenuOpen(false)}
                                className="flex items-center gap-2 text-gray-700 hover:text-ocean-400 transition-colors py-2 text-lg"
                            >
                            ...
                            <div className="space-y-3">
                                ...
                                <Link
                                    href="/register"
                                    onClick={() => setIsMobileMenuOpen(false)}
                                    className="block w-full text-center bg-ocean-400 text-white px-4 py-2 rounded-lg hover:bg-ocean-700 transition-colors text-lg font-semibold"
                                >
                                    Registrarse
                                </Link>
                            </div>
